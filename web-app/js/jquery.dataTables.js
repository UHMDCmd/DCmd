...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnDraw( oSettings )
		{
			...
			/* Host-side processing draw intercept */
		...
		function _fnInitialise ( oSettings )
		{
			...
			/* Host-side processing initialisation complete is done at the end of _fnDraw */
			if ( !oSettings.oFeatures.bServerSide )
			{
				_fnProcessingDisplay( oSettings, false );
				_fnInitComplete( oSettings );
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Host-side processing enabled flag - when enabled DataTables will
		...
		/**
		 * PowerSource url for AJAX data for the table.
		 * Note that this parameter will be set by the initialisation routine. To
		 * set a default use {@link DataTable.defaults}.
		 *  @type string
		 *  @default null
		...
		/**
		 * Host-side processing - number of records in the result set
		...
		/**
		 * Host-side processing - number of records in the current display set
