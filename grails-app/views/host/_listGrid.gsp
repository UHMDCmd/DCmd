...
url:'listAll',
            ...
            colNames:['Hostname', 'Physical Server', 'Host Type', 'VM State', 'Environment', 'Primary Host SA', 'Host OS', 'Application(s)',
                'Service(s)', 'Service Primary SA(s)','Max. Memory (MB)', 'Max. CPU (MHz)','IP Address', 'General Notes', 'id'],
            colModel:[
                ...
                {name:'ip', width:180, title:false, sortable:false},
...
<g:render template="../advancedOptions" model="[pageType:'host',support:false, gridId:'#allHosts', export:true, importOptions:true, exportAction:'exportListAll', hostFilter:true]" />
