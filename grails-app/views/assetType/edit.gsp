                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="assetType"><g:message code="assetType.name.label" default="Name" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="assetDescription"><g:message code="assetType.assetDescription.label" default="Description" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: assetTypeInstance, field: 'assets', 'errors')}">
									...
									<g:link controller="asset" action="create" params="['assetType.id': assetTypeInstance?.id]">
										${message(code: 'default.add.label', args: [message(code: 'asset.label', default: 'Asset')])}
									</g:link>
