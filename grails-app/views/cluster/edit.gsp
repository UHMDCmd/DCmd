...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'cluster.edit.label', default: 'Edit Cluster')}" />
    ...
    <body>
     <g:form method="post" controller="cluster">
         <div id="container">
             ...
             <g:render template="../show_secondary" model="[pageType:'cluster', objectId:clusterId, action:'edit', params:params]" />
             <g:render template="../breadcrumbs" model="[pageType:'cluster', action:'edit']"/>
             ...
             <article class="module width_full">
                 <div class="module_content">
                     ...
                     <g:render template="../content_title"
                               model="[entityName: 'Cluster', code:'default.edit.label']" />
