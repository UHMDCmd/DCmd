...
<g:javascript library="application" />
    ...
    <link type="text/css" href="../js/InfoViz/css/Spacetree.css" rel="stylesheet" />
    ...
    <!-- Example File -->
    <script language="javascript" type="text/javascript" src="../js/InfoViz/DCmd_nodeTree/DCmdTree.js"></script>
    ...
    <header id="header">
        <hgroup>
            ...
            <h1 class="site_title">
                ...
                <a href="/its/dcmd"><img src="${resource(dir:'images/dcmd-theme',file:'uh-logo-white.png')}" border="0" style="width:32%"> DCmd <font size='-1'><sub>1.3.2</sub></font></a>
            </h1>
