...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'service.show.label', default: 'Service')}" />
...
<div id="container">
    <g:render template="../show_secondary" model="[pageType:'service', objectId:0, action:'show']" />
    <g:render template="../breadcrumbs" model="[pageType:'service', action:'show']"/>
