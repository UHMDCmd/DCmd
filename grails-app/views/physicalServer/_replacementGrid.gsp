...
//                {name:'replacement', width:100, editable:true, edittype:'select', editoptions: {dataUrl:'${createLink(controller:"asset",action:"listAsSelect")}'}},
                ...
                {name:'replacement', width:100, editable:true, edittype:'select', editoptions: {dataUrl:'${createLink(controller:"asset",action:"altShow")}'}},
            ...
            cellEdit:editOption,
            cellsubmit: 'remote',
            cellurl:'../asset/editReplacements?assetId=${assetInstance.id}',
            keys: true
        })
