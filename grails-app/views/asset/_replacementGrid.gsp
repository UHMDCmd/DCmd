...
//            width:'1000',
            ...
            colModel:[
                ...
                {name:'replacement', width:100, editable:true, edittype:'select', formatter: 'showlink', formatoptions: {showAction:'show'}, editoptions: {dataUrl:'${createLink(controller:"asset",action:"listAsSelect")}'}},

              //  {name:'replacement', width:100, editable:true, edittype:'select',  formatter: 'showlink', editoptions: {dataUrl:'${createLink(controller:"asset",action:"altShow")}'}},
