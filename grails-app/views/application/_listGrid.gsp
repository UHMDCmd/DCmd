...
url:'listAll',
            datatype: "json",
            colNames:['App Name', 'Environment', 'Description', 'Status', 'URL', 'App Admin', 'Maint. Window', 'General Notes', 'id'],
            colModel:[
                ...
                {name:'url', width:140,title:false},
                {name:'primarySA', width:120,title:false, sortable:false},
                {name:'maintenanceWindow', width:120,title:false},
