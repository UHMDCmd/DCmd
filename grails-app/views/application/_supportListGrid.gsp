...
<g:render template="../advancedOptions" model="[pageType:'application',support:true, gridId:'#allSupportedApps', export:true,exportAction:'exportSupportList', importOption:true, importAction: 'importSupportList', hostFilter:true]" />
